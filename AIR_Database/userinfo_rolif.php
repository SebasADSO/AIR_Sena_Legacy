...
// Define una consulta SQL para seleccionar todos los campos de la tabla 'tb_encargadoyinstructor'
...
// La subconsulta se compara con el campo 'cod_usuario_fk' de la tabla 'tb_encargadoyinstructor'
$consulta = ("SELECT * FROM tb_encargadoyinstructor WHERE (SELECT cod_usuario FROM tb_usuario WHERE cedula_usuario = '$ndoc') = cod_usuario_fk");
