...
// Define una consulta SQL para seleccionar todos los campos de la tabla 'tb_usuario'
// La consulta busca el usuario cuyo 'cedula_usuario' coincida con el valor de $ndoc
$consulta = ("SELECT * FROM tb_usuario WHERE cedula_usuario='$ndoc'");
